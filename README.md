...
This is a Capston Project for Bachelor's in Technology in which we work on Machine Learning to detection  Flood occurance

General Description

Dataset's Name: SEN12-FLOOD : A SAR and Multi-spectral Dataset for Flood Detection </br>
...
* Time series of Sentinel-2 multi-spectral images. These images are composed of 12 bands,
